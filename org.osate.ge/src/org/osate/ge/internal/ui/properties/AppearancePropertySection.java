...
public class AppearancePropertySection extends AbstractPropertySection {
	...
	private void createButtonSection(final Composite parent) {
		final Button outlineButton = createButton(parent, outlineIcon, outlineColorId);
		...
		final Button fontColorButton = createButton(parent, fontColorIcon, fontColorId);
		fd = new FormData();
		...
		final Button backgroundButton = createButton(parent, backgroundIcon, backgroundColorId);
		fd = new FormData();
	...
	private class ColorSelectionListener extends SelectionAdapter {
		...
		public void widgetSelected(final SelectionEvent e) {
			...
			final Button customColorBtn = createButton(shell, customPresetColor.imageDescriptor, customColorId);
